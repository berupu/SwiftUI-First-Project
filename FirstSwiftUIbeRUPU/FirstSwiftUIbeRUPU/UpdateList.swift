...
struct UpdateList: View {
    ...
    func addUpdate(){
        store.updates.append(Update(image: "Certificate1", title: "New Title", text: "New Text", date: "December 16"))
    }
...
//            .foregroundColor(Color.white)
            ...
            .navigationBarItems(leading: Button("Plus") {
                addUpdate()
            }, trailing: EditButton())
